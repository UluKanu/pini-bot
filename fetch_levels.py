...
def create_combined_csv(rth_data, overnight_data, previous_rth_data, filename='combined2.csv', symbol='ESH6.CME@BMD'):
    """
...
def main():
    ...
    parser.add_argument("--combined_filename", type=str, default="combined2.csv", help="Filename for combined notes CSV")
